...
public class GameManager : MonoBehaviour {
	...
	void Start () {
		...
		mainLivesDisplay.text = "Lives: " + playerHealth.numberOfLives.ToString();
		mainHealthDisplay.text = "Health: " + playerHealth.healthPoints.ToString();
	...
	void Update () {
		GameManager.gm.mainLivesDisplay.text = "Lives: " + playerHealth.numberOfLives.ToString();
		GameManager.gm.mainHealthDisplay.text = "Health: " + playerHealth.healthPoints.ToString();
		switch (gameState)
		{
